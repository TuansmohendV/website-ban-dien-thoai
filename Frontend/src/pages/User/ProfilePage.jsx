                                    ...
                                    <div className="bg-white rounded-3xl p-10 border border-gray-100 shadow-sm space-y-8 flex flex-col items-center">
                                        ...
                                        <div className="w-full max-w-lg space-y-6">
                                            ...
                                            <button
                                                ...
                                                className="w-full bg-[#008d71] text-white h-16 rounded-xl font-black uppercase tracking-wider hover:bg-[#007a62] transition-colors shadow-lg shadow-[#008d71]/20"
                                            >
                                                Quay lai form
                                            </button>
                                        </div>
