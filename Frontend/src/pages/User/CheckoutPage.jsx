...
const CheckoutPage = () => {
    ...
    const [subMethod, setSubMethod] = useState('momo_sub');
                        ...
                        <div className="bg-black text-white rounded-3xl p-8 shadow-2xl sticky top-24">
                            ...
                            <div className="mb-8 p-6 bg-white/5 rounded-3xl border border-white/10">
                                ...
                                <div className="space-y-3">
                                    {[
                                        { id: 'momo', name: 'Ví MoMo Sandbox', icon: '💗' }
                                    ].map((method) => (
                                        <div key={method.id} className="space-y-3">
                                            ...
                                            {paymentMethod === 'momo' && method.id === 'momo' && (
                                                <div className="grid grid-cols-1 gap-2 p-3 bg-white/5 rounded-xl border border-white/10 animate-fadeIn">
                                                    {[
                                                        { id: 'momo_sub', name: 'MoMo Test', icon: 'https://upload.wikimedia.org/wikipedia/vi/f/fe/MoMo_Logo.png' }
                                                    ].map(wallet => (
                                                        <button
                                                            key={wallet.id}
