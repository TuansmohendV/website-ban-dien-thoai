...
const Navbar = () => {
    ...
    return (
        <nav className="w-full z-50 flex flex-col font-sans sticky top-11 bg-[#f0f2f5] py-3 md:py-4">
            <div className="max-w-[1200px] mx-auto px-4 w-full">
                
                {/* Main Row */}
                <div className="flex flex-wrap lg:flex-nowrap items-center gap-3 lg:gap-x-10 h-auto lg:h-[46px]">
                    ...
                    <Link to="/" className="flex items-center gap-2 shrink-0 group h-full">
                        ...
                        <div className="flex flex-col leading-[0.9]">
                            <span className="text-[20px] sm:text-[22px] font-black text-[#004f44] tracking-tighter uppercase">PhoneSin</span>
                    ...
                    <div className="w-full lg:flex-1 flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-3 lg:gap-x-6 h-auto lg:h-full min-w-0">
                        
                        {/* Search Bar Wrapper */}
                        <div className="w-full lg:max-w-[680px] lg:flex-1 flex flex-col relative h-[44px] lg:h-full min-w-0" ref={suggestionRef}>
                            <div className="relative group flex items-center h-full">
                                <input 
                                    ...
                                    className="w-full bg-white border border-gray-200 rounded-lg h-full pl-4 sm:pl-5 pr-14 sm:pr-28 text-[14px] text-gray-800 focus:outline-none focus:ring-1 focus:ring-[#008d71] shadow-sm font-medium placeholder-gray-400"
                                />
                                <button 
                                    onClick={handleSearch}
                                    className="absolute right-0 h-full px-4 sm:px-5 text-[#008d71] font-semibold text-[15px] flex items-center gap-2 hover:bg-gray-50 transition-all border-l border-gray-200"
                                >
                        ...
                        {/* Right Actions */}
                        <div className="flex items-center justify-end gap-2 sm:gap-4 lg:gap-7 shrink-0 h-11 lg:h-full min-w-0">
                            {/* Location */}
                ...
                <div className="flex items-center gap-3 mt-2.5 lg:ml-[200px] overflow-x-auto no-scrollbar pb-1">
